...
JNIEXPORT void JNICALL Java_org_cyanogenmod_doze_motorola_MotoSensor_native_enableWakeSensor(
...
JNIEXPORT void JNICALL Java_org_cyanogenmod_doze_motorola_MotoSensor_native_disableWakeSensor(
        UNUSED JNIEnv *env, UNUSED jclass thiz, jint wakeSensor)
{
    uint16_t wake_sensors = 0;
