...
#define AUDIO_SET_HW_DELAY_RX _IOW(AUDIO_IOCTL_MAGIC,   (AUDIO_MAX_COMMON_IOCTL_NUM+18), struct hw_delay)
#define AUDIO_SET_HW_DELAY_TX _IOW(AUDIO_IOCTL_MAGIC,   (AUDIO_MAX_COMMON_IOCTL_NUM+19), struct hw_delay)
